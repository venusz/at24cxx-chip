# AT24CXX wokwi custom chip

AT24CXX custom chip for [Wokwi](https://wokwi.com/).
...
If you want to make changes to the test project firmware, edit [test/at24cxx/AT24CXX.ino](test/at24cxx/AT24CXX.ino), and then run `make test` to rebuild the .hex file. You'll need the [arduino-cli](https://arduino.github.io/arduino-cli/latest/installation/), which is already installed in the dev container.
